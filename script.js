...
//         let greeting = "Good afternoon," + "" + name + "!"
//          return greeting
...
// console.log(greetUser("Sam","afternoon"));
...
//   if (scale ==='C') {
//     return 9/5 * temp + temp + '(Fahrenheit)'
//   } else  if (scale ==='F') {
...
// basicCalculator = (num1, num2, operand) => {
//   if (operand === 'add') {
//     return num1 + num2;
